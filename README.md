...
If you are adding a new company using the default images (not custom icons or banners), you can fetch brand assets from https://brandfetch.com/ and use the logo/banner URLs in the relevant config files.
